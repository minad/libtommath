...
#START_INS
OBJECTS=bn_error.o bn_s_mp_invmod_fast.o bn_mp_montgomery_reduce_fast.o bn_s_mp_mul_digs_fast.o \
bn_s_mp_mul_high_digs_fast.o bn_s_mp_sqr_fast.o bn_mp_2expt.o bn_mp_abs.o bn_mp_add.o bn_mp_add_d.o \
bn_mp_addmod.o bn_mp_and.o bn_s_mp_balance_mul.o bn_mp_clamp.o bn_mp_clear.o bn_mp_clear_multi.o bn_mp_cmp.o \
...
bn_mp_exptmod.o bn_s_mp_exptmod_fast.o bn_mp_exteuclid.o bn_mp_fread.o bn_mp_fwrite.o bn_mp_gcd.o \
...
bn_mp_init_set_int.o bn_mp_init_size.o bn_mp_invmod.o bn_s_mp_invmod_slow.o bn_mp_is_square.o \
bn_mp_iseven.o bn_mp_isodd.o bn_mp_jacobi.o bn_s_mp_karatsuba_mul.o bn_s_mp_karatsuba_sqr.o bn_mp_kronecker.o \
...
bn_s_mp_toom_mul.o bn_s_mp_toom_sqr.o bn_mp_toradix.o bn_mp_toradix_n.o bn_mp_unsigned_bin_size.o bn_mp_xor.o \
bn_mp_zero.o bn_prime_tab.o bn_s_mp_reverse.o bn_s_mp_add.o bn_s_mp_exptmod.o bn_s_mp_mul_digs.o \
